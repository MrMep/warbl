...
//Barbaro's EWI
struct barbaro_explicit_entry {
    uint8_t midi_note;
};

const struct barbaro_explicit_entry barbaro_explicit[128] PROGMEM = {
{73}, //00000000 C#
{73}, //00000001 C#
{73}, //00000010 C#
{73}, //00000011 C#
...
int get_note(unsigned int fingerPattern, bool sendPattern) {
    ...
    switch (fingeringSelector) {  //determine the note based on the fingering pattern
        ...
        case kModeBaroqueFlute:  //this one is very similar-- a modification will be made below.
            ...
            if (fingeringSelector == kModeChromatic && bitRead(fingerPattern, 1) == 1) {
                ret--;  //lower a semitone if R4 hole is covered and we're using the chromatic pattern
            }
            if (fingeringSelector == kModeBaroqueFlute) {
            ...
            if (fingeringSelector == kModeBombarde) {
        ...
        case kModeUilleannStandard:  //the same as the previous one, but we cancel the accidentals Bb and F#
            ...
            if (fingeringSelector == kModeUilleannStandard) {  //cancel accidentals if we're in standard uilleann mode
        ...
        case kModeBarbaroRecorder:
        case kModeBarbaroEWI:

            // tempCovered = fingerPattern >> 1;  //bitshift once to ignore bell sensor reading
            tempCovered = (0b011111110 & fingerPattern) >> 1;  //ignore thumb hole and bell sensor

            ret = pgm_read_byte(&barbaro_explicit[tempCovered].midi_note);
            ...
            //20230923 GLB
                ...
                if (fingeringSelector == kModeBarbaroRecorder) {
                     if (bitRead(holeCovered, 9)) { //thumb hole half covered - 2nd and 3rd register
                        ...
                        // if ( ((tempCovered | ~0b1111000) == ~0) ) { //B
                        //     ret = 71;
                        // } else if ((tempCovered | ~0b1110000) == ~0) { //C
                        //     ret = 72;
                        // } else if ((tempCovered | ~0b1100000) == ~0) { //C#
                        //     ret = 73;
                        // } else if ( ((tempCovered | ~0b0100000) == ~0) ||  ((tempCovered | ~0b1111111) == ~0)) { //D
                        //     ret = 74;
                        // } else if ( ((tempCovered | ~0b0111110) == ~0) ||  ((tempCovered | ~0b1111110) == ~0)) { //D#
                        //     ret = 75;
                        // } else if ( ((tempCovered | ~0b1111011) == ~0) ||  ((tempCovered | ~0b1111100) == ~0)) { //E
                        //     ret = 76;
                        // } else if ( ((tempCovered | ~0b1111010) == ~0) ) { //F
                        //     ret = 77;
                        // } else {
                        //     ret = -1;
                        // }
